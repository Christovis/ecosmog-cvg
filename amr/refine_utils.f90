...
subroutine make_grid_fine(ind_grid,ind_cell,ind,ilevel,nn,ibound,boundary_region)
  ...
  use
  extradof_commons,ONLY:sf_grad,sf,sf_old,sf_src !,sf_lp,cbf,bf_src1,bf_src2,bf_src3,bf_src4
#else
  use poisson_commons, ONLY:f,phi
  use extradof_commons,ONLY:sf_grad,sf,sf_src !,sf_lp,cbf,bf_src1,bf_src2,bf_src3,bf_src4
#endif
#ifdef RT
...
#ifndef OLDINTERP
              sf_old(iskip+ind_grid_son(i))=sf_old(ind_fathers(i,0))
#endif
           end do
        end do
     end if

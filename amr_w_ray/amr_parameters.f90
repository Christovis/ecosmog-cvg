module amr_parameters
  ...
  logical::extradof = .false. ! Enable extradof scalar mode solver
  logical::extradof2= .false. ! Enable extradof background evolution
  logical::extradof3= .false. ! Use linear fifth force calculation
  logical::extradof4= .false. ! Enable extradof transverse mode B solver
  logical::ray      = .false. ! Enable ray tracing                                      ! RAY_RAMSES 

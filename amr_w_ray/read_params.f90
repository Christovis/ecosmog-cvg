subroutine read_params
  ...
  namelist/run_params/clumpfind,extradof,extradof2,extradof3,extradof4,cosmo,pic,sink,lightcone,poisson,hydro,rt,verbose,debug &
       ...
       & ,bisec_tol,static,geom,overload,cost_weighting,aton,ray                        ! RAY_RAMSES
  ...
  namelist/extradof_params/param_b3                          
  ...
  namelist/ray_params/ray_epsilon                                                     & ! RAY_RAMSES
       & ,ray_Nx,ray_Ny                                                               & ! RAY_RAMSES
       & ,ray_opening_x,ray_opening_y                                                 & ! RAY_RAMSES
       & ,ray_cof_x,ray_cof_y,ray_x_obs                                               & ! RAY_RAMSES
       & ,ray_y_obs,ray_z_obs,ray_Lbox                                                & ! RAY_RAMSES
       & ,ray_no_bending                                                              & ! RAY_RAMSES
       & ,ray_z_s                                                                     & ! RAY_RAMSES
       & ,ray_step_test,ray_stop_after_raytracing                                     & ! RAY_RAMSES
       & ,ray_do_kappa,ray_kappa_method                                               & ! RAY_RAMSES
       & ,ray_do_shear                                                                & ! RAY_RAMSES
       & ,ray_do_deflt                                                                & ! RAY_RAMSES
       & ,ray_do_iswrs                                                                & ! RAY_RAMSES
       & ,ray_do_ngp                                                                  & ! RAY_RAMSES
       & ,ray_multi_out,ray_afresh,ray_nout,ray_zout                                    ! RAY_RAMSES
...
81 continue
  rewind(1)
  read(1,NML=extradof_params,END=84)  ! Chr 30/03/20
84 continue                                                                             ! RAY_RAMSES
  rewind(1)                                                                             ! RAY_RAMSES
  read(1,NML=ray_params,END=85)                                                         ! RAY_RAMSES
85 continue
  !-------------------------------------------------

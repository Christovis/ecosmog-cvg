module amr_commons
  ...
  ! c-Galileon (create allocatable tables to read the background expansion rate and the beta 
  !             functions of the quasi-static equation)
  real(dp),allocatable,dimension(:,:)::table_exp,table_beta
  integer :: n_lines !dimension of the arrays
